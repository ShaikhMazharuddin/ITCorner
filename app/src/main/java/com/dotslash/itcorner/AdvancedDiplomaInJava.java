...
public class AdvancedDiplomaInJava extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advanced_diploma_in_java);
    ...
    private void addClickListener() {
        listdiploma.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(AdvancedDiplomaInJava.this, listdiploma.getAdapter().getItem(i).toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
}
